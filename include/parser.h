...
/*   Updated: 2025/09/03 20:27:32 by djuarez          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
t_token *parse_arguments(t_token *cur, t_cmd *cmd, char **envp, t_exec_state *state);
...
int     process_token(t_cmd *cmd, t_token *cur, int *argc, char **envp, t_exec_state *state);
